        ...
        <div className="flex flex-col">
                        ...
                        <div className="py-20 lg:py-0">
                            ...
                            <div className="flex flex-wrap gap-6 mt-14 animate-fade-in-up stagger-6">
                                {[
                                    ...
                                    >
                                        <div
                                            className={`w-3 h-3 ${item.color} border border-black transition-transform group-hover:scale-125`}
                                        />
            ...
            >
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 relative">
                    <div
                        className={`text-center mb-16 reveal-up ${howInView ? "in-view" : ""}`}
                    >
            ...
            >
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 relative">
                    <div
                        className={`text-center mb-16 reveal-up ${featInView ? "in-view" : ""}`}
                    >
                        <h2 className="text-4xl sm:text-5xl font-black mb-5">
                            Why Lernza?
                        </h2>
                        <p className="text-lg text-muted-foreground max-w-lg mx-auto">
                            Real incentives drive real learning. Everything
                            on-chain, everything verifiable.
                        </p>
                    </div>
            ...
            >
                ...
                <div
                    className="absolute top-8 left-[4%] w-24 h-24 bg-white border-[3px] border-black shadow-[5px_5px_0_rgba(0,0,0,0.4)] rotate-12 opacity-20 animate-float"
                    style={{ animationDuration: "7s" }}
                />
                <div
                    className="absolute bottom-8 right-[6%] w-20 h-20 bg-black border-[3px] border-white/20 -rotate-6 opacity-20 animate-float"
                    style={{ animationDuration: "9s", animationDelay: "2s" }}
                />
                <div
                    className="absolute top-[40%] left-[78%] w-14 h-14 bg-success border-[3px] border-black shadow-[4px_4px_0_rgba(0,0,0,0.3)] rotate-45 opacity-[0.18] animate-float"
                    style={{ animationDuration: "6s", animationDelay: "1s" }}
                />
                <div
                    className="absolute bottom-[25%] left-[12%] w-12 h-12 bg-white border-[3px] border-black shadow-[3px_3px_0_rgba(0,0,0,0.3)] -rotate-12 opacity-[0.15] animate-float"
                    style={{ animationDuration: "8s", animationDelay: "3s" }}
                />
                <div
                    className="absolute top-[20%] right-[20%] w-10 h-10 bg-black border-[2px] border-white/20 rotate-45 opacity-[0.12] animate-float"
                    style={{ animationDuration: "10s", animationDelay: "0.5s" }}
                />
                <div
                    className="absolute bottom-[40%] right-[35%] w-8 h-8 bg-white border-[2px] border-black -rotate-6 opacity-[0.12] animate-float"
                    style={{ animationDuration: "7s", animationDelay: "4s" }}
                />
                <div
                    className="absolute top-[65%] left-[40%] w-16 h-16 bg-success/30 border-[2px] border-black/30 rotate-12 opacity-[0.15] animate-float"
                    style={{ animationDuration: "8s", animationDelay: "1.5s" }}
                />

                <div
                    className={`mx-auto max-w-7xl px-4 sm:px-6 text-center relative reveal-scale ${ctaInView ? "in-view" : ""}`}
                >
                    <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black mb-5">
                        Ready to start earning?
                    </h2>
                    <p className="text-lg mb-12 max-w-md mx-auto opacity-80">
                        Connect your Freighter wallet and create your first
                        quest. It takes two minutes.
                    </p>
                    <Button
                        variant="secondary"
                        size="lg"
            ...
            <footer className="border-t-[3px] border-black bg-white">
                <div className="mx-auto max-w-7xl px-4 sm:px-6">
                    <div className="py-12 grid grid-cols-1 sm:grid-cols-3 gap-10">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground leading-relaxed max-w-xs">
                                ...
                                Create quests, set milestones, reward learners
                                with tokens.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-4">
                                Join the community and help build the future of
                                learn-to-earn.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="border-t-[2px] border-black py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
                        <p className="text-xs font-bold text-muted-foreground">
                            Built on Stellar &middot; Open source &middot; MIT
                            License
                        </p>
